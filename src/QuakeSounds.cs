...
[PluginMetadata(Id = "QuakeSounds", Version = "1.0.0", Name = "QuakeSounds", Author = "aga", Description = "No description.")]
public partial class QuakeSounds : BasePlugin {
  ...
  private void ReloadConfig()
  {
    ...
    Core.Logger.LogInformation($"[QuakeSounds] Config reloaded. Enabled: {_config.Enabled}. KillStreakAnnounces count: {_config.KillStreakAnnounces.Count}");
  }
}